...
def registrar_pet():
    ...
    if form.validate_on_submit():
        # ⚠️ Nota: Adicione 'from flask_login import current_user' 
        # e @login_required para proteger esta rota no futuro.
        ...
        # 2. Lógica de DB
        # Assumindo ong_id=1 temporariamente, até implementar login
        ong_id_teste = 1 
        ...
        novo_animal = Animal(
            ...
            ong_id=ong_id_teste  # type: ignore
        )
